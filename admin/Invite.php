...
<body>
    ...
    <div id="main-body">
        ...
        <div id="user-navi">
            ...
            <li><a id="user-navi-choose" href="Invite.php">Invite</a></li>
        ...
        <div style="display: inline-block; padding-left: 20%;">
            <table>
                ...
                <?php
                    ...
                    $sql = "SELECT id, first_name, last_name, telephone, location FROM invite";
                    $result = $conn-> query($sql);

                    if($result-> num_rows > 0) {
                        while ($row = $result-> fetch_assoc()) {
                            echo "<tr><td>". $row["id"] ."</td><td>". $row["first_name"] ."</td><td>". 
                            $row["last_name"] ."</td><td>". $row["telephone"] ."</td><td>". $row["location"]
                            ."</td><td>";
                            ?> <form method="post" action="delete.php">
                                <input type="hidden" name="table" value="invite">
