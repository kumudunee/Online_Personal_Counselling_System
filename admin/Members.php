...
<body>
    ...
    <div id="main-body">
        ...
        <div id="user-navi">
            ...
            <li><a id="user-navi-choose" href="Members.php">Members</a></li>
        ...
        <div style="display: inline-block; padding-left: 20px;">
            <table>
                ...
                <?php
                    ...
                    $sql = "SELECT id, first_name, last_name, email, birthday, telephone, country, user_name, password FROM members";
                    $result = $conn-> query($sql);

                    if($result-> num_rows > 0) {
                        while ($row = $result-> fetch_assoc()) {
                            echo "<tr><td>". $row["id"] ."</td><td>". $row["first_name"] ."</td><td>". $row["last_name"] ."</td><td>".
                            $row["email"] ."</td><td>". $row["birthday"] ."</td><td>".  $row["telephone"] ."</td><td>". $row["country"] ."</td><td>". 
